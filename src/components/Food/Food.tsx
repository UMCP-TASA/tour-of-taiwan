...
export default function Food({food} : Props) {
    ...
    return (
        ...
        >
            <Grid item xs={6}>
                <img src={food.frontmatter.imgsrc} style={{width: '100%', height: '100%', objectFit: 'cover', borderRadius: '20px', padding: '10px'}}/>
            </Grid>
            <Grid item xs={6} style={{padding: '10px'}}> 
                <Typography gutterBottom variant="h3" component="h2" align='center' color='textPrimary' style={{fontWeight: 'bold', padding: '10px 0px'}}>
                    {food.frontmatter.name}
                </Typography>
                <iframe src={getEmbedUrl(food.frontmatter.video)} 
